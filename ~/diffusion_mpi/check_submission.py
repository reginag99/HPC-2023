...
def check_runtimes(path):
  return (   check_runtime( 100   , 100   , "0.01" , 100000 , 1  , path , 1.71 , 10 )
         and check_runtime( 100   , 100   , "0.01" , 100000 , 10 , path , 1.94 , 10 )
         and check_runtime( 10000 , 10000 , "0.02" , 1000   , 2  , path , 101 , 3 )
         and check_runtime( 10000 , 10000 , "0.02" , 1000   , 5  , path , 42.8 , 3 )
         and check_runtime( 10000 , 10000 , "0.02" , 1000   , 10 , path , 23.6 , 3 )
         and check_runtime( 10000 , 1000  , "0.6"  , 200    , 1  , path , 3.7  , 3 )
         and check_runtime( 10000 , 1000  , "0.6"  , 200    , 5  , path , 1.9  , 3 )
         )
